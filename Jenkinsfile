pipeline {
    ...
    stages {
        ...
        stage('Test') {
            steps {
                withCredentials([usernamePassword(credentialsId: '1379c781-83fb-4957-9c57-589e71f63e0a', passwordVariable: 'TENABLE_IO_SECRET_KEY', usernameVariable: 'TENABLE_IO_ACCESS_KEY')]) {
